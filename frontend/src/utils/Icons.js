...
export const trend = <i className="fa-solid fa-building-columns"></i>
export const expenses = <i className="fa-solid fa-wallet"></i>
export const user = <i class="fa-solid fa-user-large"></i>
...
export const burgerIcon = <i className="fa-solid fa-bars"></i>
